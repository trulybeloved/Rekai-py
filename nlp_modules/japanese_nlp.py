...
FundamentalPatterns = basic_nlp.FundamentalPatterns
class Classifier:
...
class TextSplitter:
    ...
    @staticmethod
    def split_para_to_list_of_lines(input_text: str, *, strip_each_line: bool = False, trim_list: bool = True, delimiter: str = '。') -> list:
